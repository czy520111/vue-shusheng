    ...
    function ThreeBSP(treeIsh, matrix1, options) {
      ...
      if ((base = this.options).timer == null) {
        base.timer = new Timelimit(
          (ref = (ref1 = this.options.timer) != null ? ref1.timeout : void 0) !=
          null
            ? ref
            : this.options.timeout,
          (ref2 =
            (ref3 = this.options.timer) != null ? ref3.progress : void 0) !=
          null
            ? ref2
      ...
      fn1 = (function (_this) {
        return function (face, i) {
          var faceVertexUvs,
            ...
            vertex;
          faceVertexUvs =
            (ref1 = geometry.faceVertexUvs) != null ? ref1[0][i] : void 0;
        ...
        (function (_this) {
          return function () {
            ...
            return _this.polygons
              .slice()
              .concat(
                ((ref1 = _this.front) != null ? ref1.allPolygons() : void 0) ||
                  []
              )
              .concat(
                ((ref = _this.back) != null ? ref.allPolygons() : void 0) || []
              );
          };
        })(this)
      );
